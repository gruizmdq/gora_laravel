<template>
	<div>
		<input required type="text" :data-code="code" name="street" placeholder="Ingrese una calle" v-model="query" v-on:keyup="autoComplete()" class="validate form-control address">
